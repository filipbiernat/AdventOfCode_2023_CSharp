...
namespace AdventOfCode2023.Day12
{
    public class Day12B : IDay
    {
        public void Run()
        {
            ...
            rowsOfSprings = rowsOfSprings
                .Select(UnfoldRowOfSprings)
                .ToList();
        ...
        private static (string Layout, List<int> Condition) UnfoldRowOfSprings((string Layout, List<int> Condition) rowOfSprings)
        {
            ...
            string layout = string.Join("?", Enumerable.Repeat(rowOfSprings.Layout, 5));
            List<int> condition = Enumerable
                .Repeat(rowOfSprings.Condition, 5)
                .SelectMany(partialCondition => partialCondition)
                .ToList();
            return new(layout, condition);
        }
